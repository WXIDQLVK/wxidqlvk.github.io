...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* 🌟 空白占位窄一点：把占位高度调小（例如 pt-[48px]），让下方卡片往上收，与向下的导航栏完美衔接 */}
      <div className={`w-full pointer-events-none ${isStandalone ? 'pt-[48px] sm:pt-[56px] block' : 'hidden'}`} aria-hidden="true"></div>
    </>
  );
}
