        ...
        <div className="flex flex-col items-center gap-4 w-full">
          ...
          <div className="w-full min-w-0">
            ...
            */}
            ...
            <p className="text-xs sm:text-sm md:text-base text-slate-700 dark:text-slate-300 font-medium leading-relaxed max-w-md mx-auto transition-colors duration-700 line-clamp-2 md:line-clamp-none">
              {siteConfig.bio}
            </p>
          </div>
        </div>
